...
class AtmCollection extends StatefulWidget {
  final Request requisition;

  const AtmCollection({super.key, required this.requisition});

  @override
  State<AtmCollection> createState() => _AtmCollectionState();
}

class _AtmCollectionState extends State<AtmCollection> {
  ...
  Future<void> _confirmPickup() async {
    ...
    if (_sealNumberController.text.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please enter the seal number'),
          backgroundColor: Colors.red,
        ),
      );
      return;
    ...
    // Always send the last known location if available, otherwise send null
