...
class CdmCollection extends StatefulWidget {
  final Request requisition;

  const CdmCollection({super.key, required this.requisition});

  @override
  State<CdmCollection> createState() => _CdmCollectionState();
}

class _CdmCollectionState extends State<CdmCollection> {
