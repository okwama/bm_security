...
class CalloutPage extends StatefulWidget {
  ...
  @override
  State<CalloutPage> createState() => _CalloutPageState();
}

class _CalloutPageState extends State<CalloutPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Callout Service'),
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Callout Service'),
          content: const Text(
            'Callout is an emergency response service for urgent situations. '
            'This service requires immediate response and assessment with enhanced security measures.',
          ),
          actions: [
            TextButton(
