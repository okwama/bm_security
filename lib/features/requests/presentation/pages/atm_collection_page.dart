...
class AtmCollectionPage extends StatefulWidget {
  final RequestEntity request;

  const AtmCollectionPage({
    super.key,
    required this.request,
  });

  @override
  State<AtmCollectionPage> createState() => _AtmCollectionPageState();
}

class _AtmCollectionPageState extends State<AtmCollectionPage> {
      ...
      final result = await Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => CashCountPage(
            ...
            isAtmCashCount: true, // ATM uses atm_cash_counts table
          ),
        ),
      );
  ...
  Future<void> _submitCollection() async {
    ...
    if (_atmIdController.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please enter ATM ID before submitting'),
          backgroundColor: Colors.orange,
        ),
      );
      return;
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('ATM collection completed successfully!'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('ATM Collection'),
      ...
      body: _isLoading
          ? const LoadingWidget(message: 'Loading ATM collection...')
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow('Service Type', widget.request.serviceType?.name ?? 'ATM Loading'),
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'ATM cash counts are stored separately from regular cash counts',
                      style: TextStyle(
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'ATM cash count completed - Total: ${_cashCount!.totalAmount} KES',
                        style: TextStyle(
            ...
            SizedBox(
              ...
              child: TextButton.icon(
                ...
                label: Text(
                  _cashCount != null ? 'Edit ATM Cash Count' : 'Enter ATM Denominations',
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              maxLines: 3,
              decoration: InputDecoration(
                hintText: 'Enter any notes about the ATM collection...',
                hintStyle: TextStyle(fontSize: 12, color: Colors.grey.shade500),
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(8),
                ),
  ...
  Widget _buildSubmitButton() {
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        ...
        label: Text(
          _isSubmitting ? 'Submitting...' : 'Complete ATM Collection',
          style: const TextStyle(
            fontSize: 16,
            fontWeight: FontWeight.bold,
          ),
