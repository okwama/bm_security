...
class _PickDropPageState extends State<PickDropPage> {
  ...
  Future<void> _pickImage() async {
    try {
      ...
      if (image != null && mounted) {
        setState(() {
          _pickupImageFile = image;
          _pickupImageUrl = null;
        });
      }
    } catch (e) {
      if (!mounted) return;
  ...
  Future<void> _navigateToCashCount() async {
    try {
      final result = await Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => CashCountPage(
            ...
            isAtmCashCount: false, // Vault uses regular cash_counts table
            onConfirm: null, // Don't auto-save, just return data
          ),
        ),
      );
      ...
      if (result != null && result is CashCountEntity) {
        ...
        // Show confirmation that cash count data is ready
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Cash count data ready. Click "Confirm Pickup" to save.'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _isLoading
          ? const LoadingWidget(message: 'Loading pick and drop...')
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow('Service Type', widget.request.serviceType?.name ?? 'Pick and Drop'),
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(_pickupImageFile != null ? 'Retake Pickup Photo' : 'Take Pickup Photo'),
                style: ElevatedButton.styleFrom(
